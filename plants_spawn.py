...
class PlantsGreenSpawer:
    ...
    def update(self,y, keyboard):
        if -1840 < -1750 + y < -1700:
            if len(self.plants) == 0: self.spawn_greenp(y) 
        for p in self.plants:
            p.x -= 5
            if keyboard.up and y < 1300: p.y += 10
            if keyboard.down and (-1750 +y ) > -1750: p.y -= 10
...
class PlantsRedSpawer:
    ...
    def update(self, y, keyboard):
        ...
        if -1840 < -1750 + y < -1700:
            if len(self.redplants) == 0: self.spawn_redplants()    
        for redplant in self.redplants: 
            redplant.x -= 5
            if keyboard.up and y < 1300: redplant.y += 10
            if keyboard.down and (-1750 +y ) > -1750: redplant.y -= 10
...
class PlantsPurpleSpawer:
    ...
    def update(self, y, keyboard):
        ...
        if -1840 < -1750 + y < -1700:
            if len(self.purples) == 0: self.spawn_purples()    
        for purple in self.purples: 
            purple.x -= 5
            if keyboard.up and y < 1300: purple.y += 10
            if keyboard.down and (-1750 +y ) > -1750: purple.y -= 10
        
        self.purples = [r for r in self.purples if r.x > -800]
